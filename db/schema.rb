...
ActiveRecord::Schema.define(version: 2020_12_30_080459) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["purpose_id"], name: "index_notifications_on_purpose_id"
  ...
  add_foreign_key "notifications", "purposes"
